#!/usr/bin/env python
"""Usage:
    vtk_to_twophase.py (--vtkin <vtkin>) [--lbin <lbin>] [--threshold <thres>] [--plot]
...
if __name__=='__main__':
    ...
    if threeD:
        ...
        kurv = 2.0 / meanradius # replace with formula to calculate mean curvature of interface for ellipsoid!
        if liquiddrop:
    ...
    if tension:
        ...
        print("Estimated surface tension: {0:f}".format(abs(p_L-p_V)/kurv))
